...
import { Mail, Lock, Eye, EyeOff, Ticket, ShieldCheck, QrCode, Shield, Zap, Headphones, ArrowRight, User, Phone, ArrowLeft, Loader2 } from 'lucide-react';
...
export default function Register() {
  ...
  const handleRegister = async (e) => {
    ...
    const { error: signUpError } = await signUpWithEmail(email, password, name, phone);
      ...
      <div className="relative z-10 flex flex-col lg:flex-row w-full h-full">
        ...
        <div className="hidden lg:flex lg:w-[45%] flex-col justify-between p-12 xl:p-16">
          <div>
            ...
            <h1 className="text-5xl xl:text-6xl font-black text-white mb-4 leading-tight tracking-tight">
              Join the <br/>
              <span className="text-[#facc15]">Crowd!</span>
            </h1>
            <div className="w-16 h-1 bg-[#facc15] mb-6"></div>
            
            <p className="text-gray-300 text-lg mb-10 max-w-sm font-medium leading-relaxed">
              Create an account to explore unforgettable concerts, book your tickets and experience live like never before.
            </p>
        ...
        <div className="lg:hidden px-6 pt-10 pb-4 relative z-10">
          ...
          <div className="flex justify-between items-start relative mt-4">
             <div className="w-[65%]">
               <h1 className="text-4xl font-black text-white leading-tight">Create <br/><span className="text-[#facc15]">Account</span></h1>
               <p className="text-gray-300 text-[13px] mt-3 font-medium leading-relaxed">Register for free and start<br/>your musical journey</p>
             </div>
          </div>
        </div>
          ...
          <div className="w-full max-w-[420px] bg-[#120a0b] lg:bg-white rounded-[24px] lg:rounded-[30px] p-6 sm:p-8 border border-[#2a1618] lg:border-gray-50 shadow-2xl lg:shadow-[0_20px_50px_-12px_rgba(0,0,0,0.05)] mb-4 lg:mb-8 relative z-10 mt-6 lg:mt-0">
            ...
            <div className="hidden lg:block text-center mb-5">
              <h2 className="text-2xl font-black text-gray-900 mb-1">
                Create <span className="text-[#8c1c24]">Account</span>
              </h2>
            ...
            <form onSubmit={handleRegister} className="space-y-4 lg:space-y-3">
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 lg:pl-3.5 flex items-center pointer-events-none">
                  <Phone size={18} className="text-gray-500 lg:text-gray-400" />
                </div>
                <input 
                  type="tel" 
                  value={phone}
            ...
            <div className="mt-6 lg:mt-5 text-center text-[13px] font-medium text-gray-500 lg:text-gray-600">
              Already have an account? <Link to="/login" className="text-[#facc15] lg:text-[#8c1c24] font-bold hover:underline transition-all ml-1">Log In</Link>
            </div>
