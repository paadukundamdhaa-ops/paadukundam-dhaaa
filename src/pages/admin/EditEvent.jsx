    ...
    <div className="min-h-screen bg-[#f8f9fa] pb-32 text-black">
      ...
      <div className="max-w-[1600px] mx-auto px-6 pt-8 flex gap-8 relative items-start">
        ...
        <div className="flex-1 max-w-4xl space-y-10">
          ...
          <section id="basic-info" className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="flex gap-6">
                <div className="flex-1">
                  ...
                  <div className="flex">
                    ...
                    <input type="text" value={slug} onChange={e => setSlug(e.target.value)} className="flex-1 border border-gray-300 rounded-r-lg px-4 py-2.5 text-sm focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none" placeholder="arijit-singh-live" />
                  </div>
                </div>
                <div className="w-1/3">
              ...
              <div>
                ...
                <textarea rows="2" value={shortDescription} onChange={e => setShortDescription(e.target.value)} className="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none resize-none" placeholder="A brief 1-2 sentence summary for event cards..."></textarea>
              </div>
              <div>
                ...
                <div className="border border-gray-300 rounded-lg overflow-hidden">
                  ...
                  <textarea rows="6" value={fullDescription} onChange={e => setFullDescription(e.target.value)} className="w-full px-4 py-3 text-sm outline-none resize-none" placeholder="Write the full event details here..."></textarea>
                </div>
              </div>
            </div>
          </section>
            ...
            <div className="p-6">
              ...
              <div className="mt-6 pt-6 border-t border-gray-100 flex items-center justify-between">
                ...
                <label className="relative inline-flex items-center cursor-pointer">
                  <input type="checkbox" checked={isCountdownEnabled} onChange={e => setIsCountdownEnabled(e.target.checked)} className="sr-only peer" />
          ...
          {/* Step 12: Terms, Conditions & Policies */}
          ...
          <section id="seo-settings" className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div className="p-6 space-y-6">
              <div>
                ...
                <input type="text" value={seoTitle} onChange={e => setSeoTitle(e.target.value)} className="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm outline-none" />
              </div>
              <div>
                ...
                <textarea rows="2" value={seoDescription} onChange={e => setSeoDescription(e.target.value)} className="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm outline-none"></textarea>
              </div>
            </div>
          </section>
          ...
          <section id="organizer-info" className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div className="p-6 grid grid-cols-2 gap-6">
              <div>
                ...
                <input type="text" value={organizerName} onChange={e => setOrganizerName(e.target.value)} className="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm outline-none" />
              </div>
              <div>
                <label className="block text-[13px] font-bold text-gray-700 mb-1.5">Contact Email</label>
                <input type="email" value={organizerEmail} onChange={e => setOrganizerEmail(e.target.value)} className="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm outline-none" />
              </div>
            </div>
          </section>
